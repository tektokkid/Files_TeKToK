...
local TeKToKChengName = database:get(bot_id.."TeKToK:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TeKToKChengName then 
send(msg.chat_id_, msg.id_, "يولد هذا غير اسمه لك ها كلب  ["..TeKToKChengName..']')
database:del(bot_id.."TeKToK:Cheng:Name"..data.id_) 
end
end
...
database:set(bot_id.."TeKToK:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
